...
//                 className="w-full sm:w-auto cursor-pointer px-4 py-2 text-sm sm:text-base text-center text-white bg-purple-600 hover:bg-purple-700 rounded-lg transition duration-300 ease-in-out active:scale-95"
//               >
//                 Edit Property
//               </button>
//               <button
//                 onClick={() => setShowDeleteModal(true)}
//                 className="w-full sm:w-auto cursor-pointer px-4 py-2 text-sm sm:text-base text-center text-white bg-red-600 hover:bg-red-700 rounded-lg transition duration-300 ease-in-out active:scale-95"
//               >
//                 Delete Property
//               </button>
//             </div>
